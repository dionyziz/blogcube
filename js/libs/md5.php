Md5 = {
    ...
    */
    ,md5: function (s){ return this.binl2hex(this.core_md5(this.str2binl(s), s.length * this.chrsz));} /* hex md5 */
    ...
    */
    ,core_hmac_md5: function (key, data) {
        ...
        if(bkey.length > 16) bkey = this.core_md5(bkey, this.key.length * this.chrsz);
